  ...
  return async (event, context, callback) => {
    ...
    for (const eventProcessorName of eventProcessorMapping.keys()) {
      try {
        ...
        const result = await eventProcessorMapping.get(eventProcessorName)(
          routeConfig[eventProcessorName],
          event,
          context
        );
    ...
    return "No event processor found to handle this kind of event!";
  };
}
